domain: file "../pddl-codes/5-nodes/5n-2s-5v/domain-5n-2s-5v.pddl"
problem: file "../pddl-codes/5-nodes/5n-2s-3v/instance-5n-2s-3v.pddl"
...
externfun decrease_embedding_cpu_action_migrate_amf0_ns1(embedding_cpu : real_type ; scaling_factor : real_type ; vnfs_required_cpu : real_type ; ): real_type "../pddl-codes/5-nodes/5n-2s-5v/domain-5n-2s-5v.h" ;
...
adjacent_nodes_i_j[n3_n4][n3][n4]:= true; 
adjacent_nodes_j_i[n3_n4][n4][n3]:= true; 
adjacent_nodes_i_j[n1_n4][n1][n4]:= true; 
adjacent_nodes_j_i[n1_n4][n1][n4]:= true; 
adjacent_nodes_i_j[n2_n4][n2][n4]:= true; 
adjacent_nodes_j_i[n2_n4][n4][n2]:= true; 
adjacent_nodes_i_j[n1_n5][n1][n5]:= true; 
adjacent_nodes_j_i[n1_n5][n5][n1]:= true; 
adjacent_nodes_i_j[n2_n5][n2][n5]:= true; 
adjacent_nodes_j_i[n2_n5][n5][n2]:= true; 
adjacent_nodes_i_j[n3_n5][n3][n5]:= true; 
adjacent_nodes_j_i[n3_n5][n5][n3]:= true; 
adjacent_nodes_i_j[n4_n5][n4][n5]:= true; 
adjacent_nodes_j_i[n4_n5][n5][n4]:= true; 
...
adjacent_nodes_i_j[inner_path_n5][n5][n5]:= true; 
adjacent_nodes_j_i[inner_path_n5][n5][n5]:= true; 
next_vnf[amf0_1][smf0_1]:= true; 
next_vnf[smf0_1][upf0_1]:= true; 
vnf_mapped_to[amf0_1][n1]:= true; 
vnf_mapped_to[smf0_1][n2]:= true; 
vnf_mapped_to[upf0_1][n3]:= true; 
link_mapped_to[amf0_smf0_1][n1_n2]:= true; 
link_mapped_to[smf0_upf0_1][n2_n3]:= true; 
next_vnf[amf0_2][smf0_2]:= true; 
next_vnf[smf0_2][upf0_2]:= true; 
vnf_mapped_to[amf0_2][n4]:= true; 
vnf_mapped_to[smf0_2][n5]:= true; 
vnf_mapped_to[upf0_2][n1]:= true; 
link_mapped_to[amf0_smf0_2][n4_n5]:= true; 
link_mapped_to[smf0_upf0_2][n1_n5]:= true; 
embedding_cpu[n1] := 16.0000;
embedding_cpu[n2] := 64.0000;
embedding_cpu[n3] := 64.0000;
embedding_cpu[n4] := 64.0000;
embedding_cpu[n5] := 64.0000;
embedding_bandwidth[n1_n2] := 180.000;
embedding_bandwidth[n1_n3] := 200.000;
embedding_bandwidth[n2_n4] := 200.000;
embedding_bandwidth[n3_n4] := 200.000;
embedding_bandwidth[n1_n4] := 200.000;
embedding_bandwidth[n2_n3] := 180.000;
embedding_bandwidth[n1_n5] := 180.000;
embedding_bandwidth[n2_n5] := 200.000;
embedding_bandwidth[n3_n5] := 200.000;
embedding_bandwidth[n4_n5] := 180.000;
...
embedding_bandwidth[inner_path_n5] := 4.00000E+07;
all_event_true := true;
g_n := 0;
h_n := 0;
f_n := 0;
...
goal "enjoy" 
 ((( embedding_cpu[n1]) > (16.0000))) & ((( embedding_bandwidth[n1_n2]) = (substrate_bandwidth_capacity))) & ((( embedding_bandwidth[n1_n3]) < (substrate_bandwidth_capacity)))& !DAs_ongoing_in_goal_state(); 
