(define (problem instance-5n-4s-3v)

	(:domain domain-5n-4s-3v)
	...
	(:init
		...
		(vnf-mapped-to upf0-3 n5)
		;links mappings
		(link-mapped-to amf0-smf0-3 n3-n4)
		(link-mapped-to smf0-upf0-3 n3-n5)

		; NETWORK SLICE 4 -> mMTC (SERVICE FUNCTION CHAIN)
		(next-vnf amf0-4 smf0-4)
		(next-vnf smf0-4 upf0-4)
		; vnfs mappings
		(vnf-mapped-to amf0-4 n1)
		(vnf-mapped-to smf0-4 n4)
		(vnf-mapped-to upf0-4 n5)
		;links mappings
		(link-mapped-to amf0-smf0-4 n1-n4)
		(link-mapped-to smf0-upf0-4 n4-n5)
