(define (problem instance-5n-6s-3v)

	(:domain domain-5n-6s-3v)
	...
	(:init
        ...
        (=(substrate-bandwidth-capacity) 200) ; 200Gbps
		...
		; vnfs mappings
		(vnf-mapped-to amf0-5 n3)
		(vnf-mapped-to smf0-5 n4)
		(vnf-mapped-to upf0-5 n1)
		;links mappings
		(link-mapped-to amf0-smf0-5 n3-n4)
		(link-mapped-to smf0-upf0-5 n1-n4)

		; NETWORK SLICE 6 -> urllc (SERVICE FUNCTION CHAIN)
		(next-vnf amf0-6 smf0-6)
		(next-vnf smf0-6 upf0-6)
		; vnfs mappings
		(vnf-mapped-to amf0-6 n2)
		(vnf-mapped-to smf0-6 n3)
		(vnf-mapped-to upf0-6 n4)
		;links mappings
		(link-mapped-to amf0-smf0-6 n2-n3)
		(link-mapped-to smf0-upf0-6 n3-n4)
		...
		(= (embedding-bandwidth n3-n4) 140)
		(= (embedding-bandwidth n1-n4) 200)
		(= (embedding-bandwidth n2-n3) 140)
