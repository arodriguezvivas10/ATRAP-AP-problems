domain: file "../pddl-codes/4n-2s-3v/domain-4n-2s-3v.pddl"
problem: file "../pddl-codes/4n-2s-3v/instance-4n-2s-3v.pddl"
...
externfun decrease_embedding_cpu_action_migrate_amf0_ns1(embedding_cpu : real_type ; scaling_factor : real_type ; vnfs_required_cpu : real_type ; ): real_type "../pddl-codes/4n-2s-3v/domain-4n-2s-3v.h" ;
...
vnf_mapped_to[smf0_2][n1]:= true; 
vnf_mapped_to[upf0_2][n3]:= true; 
link_mapped_to[amf0_smf0_2][n1_n2]:= true; 
link_mapped_to[smf0_upf0_2][n1_n3]:= true; 
embedding_cpu[n1] := 75.0000;
embedding_cpu[n2] := 1.00000;
embedding_cpu[n3] := 75.0000;
embedding_cpu[n4] := 75.0000;
embedding_bandwidth[n1_n2] := 180.000;
embedding_bandwidth[n1_n3] := 180.000;
embedding_bandwidth[n2_n4] := 160.000;
embedding_bandwidth[n3_n4] := 400.000;
embedding_bandwidth[n1_n4] := 400.000;
embedding_bandwidth[n2_n3] := 400.000;
...
goal "enjoy" 
 ((( embedding_cpu[n1]) > (1.00000))) & ((( embedding_cpu[n2]) > (1.00000))) & ((( embedding_cpu[n3]) > (1.00000))) & ((( embedding_cpu[n4]) > (1.00000)))& !DAs_ongoing_in_goal_state(); 
