...
double decrease_embedding_bandwidth_action_migrate_amf0_ns2(double embedding_bandwidth, double required_bandwidth_mmtc ) {
	 return round_k_digits(embedding_bandwidth-(required_bandwidth_mmtc),2); 
}

double increase_embedding_bandwidth_action_migrate_amf0_ns2(double embedding_bandwidth, double required_bandwidth_mmtc ) {
	 return round_k_digits(embedding_bandwidth+(required_bandwidth_mmtc),2); 
}
...
double decrease_embedding_bandwidth_action_migrate_smf0_ns2(double embedding_bandwidth, double required_bandwidth_mmtc ) {
	 return round_k_digits(embedding_bandwidth-(required_bandwidth_mmtc),2); 
}

double increase_embedding_bandwidth_action_migrate_smf0_ns2(double embedding_bandwidth, double required_bandwidth_mmtc ) {
	 return round_k_digits(embedding_bandwidth+(required_bandwidth_mmtc),2); 
}
...
double decrease_embedding_bandwidth_action_migrate_upf0_ns2(double embedding_bandwidth, double required_bandwidth_mmtc ) {
	 return round_k_digits(embedding_bandwidth-(required_bandwidth_mmtc),2); 
}

double increase_embedding_bandwidth_action_migrate_upf0_ns2(double embedding_bandwidth, double required_bandwidth_mmtc ) {
	 return round_k_digits(embedding_bandwidth+(required_bandwidth_mmtc),2); 
}
...
double decrease_embedding_bandwidth_action_migrate_amf1_ns2(double embedding_bandwidth, double required_bandwidth_mmtc ) {
	 return round_k_digits(embedding_bandwidth-(required_bandwidth_mmtc),2); 
}

double increase_embedding_bandwidth_action_migrate_amf1_ns2(double embedding_bandwidth, double required_bandwidth_mmtc ) {
	 return round_k_digits(embedding_bandwidth+(required_bandwidth_mmtc),2); 
}
...
double decrease_embedding_bandwidth_action_migrate_smf1_ns2(double embedding_bandwidth, double required_bandwidth_mmtc ) {
	 return round_k_digits(embedding_bandwidth-(required_bandwidth_mmtc),2); 
}

double increase_embedding_bandwidth_action_migrate_smf1_ns2(double embedding_bandwidth, double required_bandwidth_mmtc ) {
	 return round_k_digits(embedding_bandwidth+(required_bandwidth_mmtc),2); 
}
...
double decrease_embedding_bandwidth_action_migrate_amf0_ns3(double embedding_bandwidth, double required_bandwidth_embb ) {
	 return round_k_digits(embedding_bandwidth-(required_bandwidth_embb),2); 
}

double increase_embedding_bandwidth_action_migrate_amf0_ns3(double embedding_bandwidth, double required_bandwidth_embb ) {
	 return round_k_digits(embedding_bandwidth+(required_bandwidth_embb),2); 
}
...
double decrease_embedding_bandwidth_action_migrate_smf0_ns3(double embedding_bandwidth, double required_bandwidth_embb ) {
	 return round_k_digits(embedding_bandwidth-(required_bandwidth_embb),2); 
}

double increase_embedding_bandwidth_action_migrate_smf0_ns3(double embedding_bandwidth, double required_bandwidth_embb ) {
	 return round_k_digits(embedding_bandwidth+(required_bandwidth_embb),2); 
}
...
double decrease_embedding_bandwidth_action_migrate_upf0_ns3(double embedding_bandwidth, double required_bandwidth_embb ) {
	 return round_k_digits(embedding_bandwidth-(required_bandwidth_embb),2); 
}

double increase_embedding_bandwidth_action_migrate_upf0_ns3(double embedding_bandwidth, double required_bandwidth_embb ) {
	 return round_k_digits(embedding_bandwidth+(required_bandwidth_embb),2); 
}
...
double decrease_embedding_bandwidth_action_migrate_amf1_ns3(double embedding_bandwidth, double required_bandwidth_embb ) {
	 return round_k_digits(embedding_bandwidth-(required_bandwidth_embb),2); 
}

double increase_embedding_bandwidth_action_migrate_amf1_ns3(double embedding_bandwidth, double required_bandwidth_embb ) {
	 return round_k_digits(embedding_bandwidth+(required_bandwidth_embb),2); 
}
...
double decrease_embedding_bandwidth_action_migrate_smf1_ns3(double embedding_bandwidth, double required_bandwidth_embb ) {
	 return round_k_digits(embedding_bandwidth-(required_bandwidth_embb),2); 
}

double increase_embedding_bandwidth_action_migrate_smf1_ns3(double embedding_bandwidth, double required_bandwidth_embb ) {
	 return round_k_digits(embedding_bandwidth+(required_bandwidth_embb),2); 
}
...
double decrease_embedding_cpu_action_migrate_amf0_ns5(double embedding_cpu, double scaling_factor, double vnfs_required_cpu ) {
	 return round_k_digits(embedding_cpu-((scaling_factor) * (vnfs_required_cpu)),2); 
}

double increase_embedding_cpu_action_migrate_amf0_ns5(double embedding_cpu, double scaling_factor, double vnfs_required_cpu ) {
	 return round_k_digits(embedding_cpu+((scaling_factor) * (vnfs_required_cpu)),2); 
}

double decrease_embedding_bandwidth_action_migrate_amf0_ns5(double embedding_bandwidth, double required_bandwidth_mmtc ) {
	 return round_k_digits(embedding_bandwidth-(required_bandwidth_mmtc),2); 
}

double increase_embedding_bandwidth_action_migrate_amf0_ns5(double embedding_bandwidth, double required_bandwidth_mmtc ) {
	 return round_k_digits(embedding_bandwidth+(required_bandwidth_mmtc),2); 
}

double decrease_embedding_cpu_action_migrate_smf0_ns5(double embedding_cpu, double scaling_factor, double vnfs_required_cpu ) {
	 return round_k_digits(embedding_cpu-((scaling_factor) * (vnfs_required_cpu)),2); 
}

double increase_embedding_cpu_action_migrate_smf0_ns5(double embedding_cpu, double scaling_factor, double vnfs_required_cpu ) {
	 return round_k_digits(embedding_cpu+((scaling_factor) * (vnfs_required_cpu)),2); 
}

double decrease_embedding_bandwidth_action_migrate_smf0_ns5(double embedding_bandwidth, double required_bandwidth_mmtc ) {
	 return round_k_digits(embedding_bandwidth-(required_bandwidth_mmtc),2); 
}

double increase_embedding_bandwidth_action_migrate_smf0_ns5(double embedding_bandwidth, double required_bandwidth_mmtc ) {
	 return round_k_digits(embedding_bandwidth+(required_bandwidth_mmtc),2); 
}
...
double decrease_embedding_cpu_action_migrate_upf0_ns5(double embedding_cpu, double scaling_factor, double vnfs_required_cpu ) {
	 return round_k_digits(embedding_cpu-((scaling_factor) * (vnfs_required_cpu)),2); 
}

double increase_embedding_cpu_action_migrate_upf0_ns5(double embedding_cpu, double scaling_factor, double vnfs_required_cpu ) {
	 return round_k_digits(embedding_cpu+((scaling_factor) * (vnfs_required_cpu)),2); 
}

double decrease_embedding_bandwidth_action_migrate_upf0_ns5(double embedding_bandwidth, double required_bandwidth_mmtc ) {
	 return round_k_digits(embedding_bandwidth-(required_bandwidth_mmtc),2); 
}

double increase_embedding_bandwidth_action_migrate_upf0_ns5(double embedding_bandwidth, double required_bandwidth_mmtc ) {
	 return round_k_digits(embedding_bandwidth+(required_bandwidth_mmtc),2); 
}
...
double decrease_embedding_cpu_action_migrate_amf1_ns5(double embedding_cpu, double scaling_factor, double vnfs_required_cpu ) {
	 return round_k_digits(embedding_cpu-((scaling_factor) * (vnfs_required_cpu)),2); 
}

double increase_embedding_cpu_action_migrate_amf1_ns5(double embedding_cpu, double scaling_factor, double vnfs_required_cpu ) {
	 return round_k_digits(embedding_cpu+((scaling_factor) * (vnfs_required_cpu)),2); 
}

double decrease_embedding_bandwidth_action_migrate_amf1_ns5(double embedding_bandwidth, double required_bandwidth_mmtc ) {
	 return round_k_digits(embedding_bandwidth-(required_bandwidth_mmtc),2); 
}

double increase_embedding_bandwidth_action_migrate_amf1_ns5(double embedding_bandwidth, double required_bandwidth_mmtc ) {
	 return round_k_digits(embedding_bandwidth+(required_bandwidth_mmtc),2); 
}
...
double decrease_embedding_cpu_action_migrate_smf1_ns5(double embedding_cpu, double scaling_factor, double vnfs_required_cpu ) {
	 return round_k_digits(embedding_cpu-((scaling_factor) * (vnfs_required_cpu)),2); 
}

double increase_embedding_cpu_action_migrate_smf1_ns5(double embedding_cpu, double scaling_factor, double vnfs_required_cpu ) {
	 return round_k_digits(embedding_cpu+((scaling_factor) * (vnfs_required_cpu)),2); 
}

double decrease_embedding_bandwidth_action_migrate_smf1_ns5(double embedding_bandwidth, double required_bandwidth_mmtc ) {
	 return round_k_digits(embedding_bandwidth-(required_bandwidth_mmtc),2); 
}

double increase_embedding_bandwidth_action_migrate_smf1_ns5(double embedding_bandwidth, double required_bandwidth_mmtc ) {
	 return round_k_digits(embedding_bandwidth+(required_bandwidth_mmtc),2); 
}

double decrease_embedding_cpu_action_migrate_amf0_ns6(double embedding_cpu, double scaling_factor, double vnfs_required_cpu ) {
	 return round_k_digits(embedding_cpu-((scaling_factor) * (vnfs_required_cpu)),2); 
}

double increase_embedding_cpu_action_migrate_amf0_ns6(double embedding_cpu, double scaling_factor, double vnfs_required_cpu ) {
	 return round_k_digits(embedding_cpu+((scaling_factor) * (vnfs_required_cpu)),2); 
}

double decrease_embedding_bandwidth_action_migrate_amf0_ns6(double embedding_bandwidth, double required_bandwidth_embb ) {
	 return round_k_digits(embedding_bandwidth-(required_bandwidth_embb),2); 
}

double increase_embedding_bandwidth_action_migrate_amf0_ns6(double embedding_bandwidth, double required_bandwidth_embb ) {
	 return round_k_digits(embedding_bandwidth+(required_bandwidth_embb),2); 
}

double decrease_embedding_cpu_action_migrate_smf0_ns6(double embedding_cpu, double scaling_factor, double vnfs_required_cpu ) {
	 return round_k_digits(embedding_cpu-((scaling_factor) * (vnfs_required_cpu)),2); 
}

double increase_embedding_cpu_action_migrate_smf0_ns6(double embedding_cpu, double scaling_factor, double vnfs_required_cpu ) {
	 return round_k_digits(embedding_cpu+((scaling_factor) * (vnfs_required_cpu)),2); 
}

double decrease_embedding_bandwidth_action_migrate_smf0_ns6(double embedding_bandwidth, double required_bandwidth_embb ) {
	 return round_k_digits(embedding_bandwidth-(required_bandwidth_embb),2); 
}

double increase_embedding_bandwidth_action_migrate_smf0_ns6(double embedding_bandwidth, double required_bandwidth_embb ) {
	 return round_k_digits(embedding_bandwidth+(required_bandwidth_embb),2); 
}
...
double decrease_embedding_cpu_action_migrate_upf0_ns6(double embedding_cpu, double scaling_factor, double vnfs_required_cpu ) {
	 return round_k_digits(embedding_cpu-((scaling_factor) * (vnfs_required_cpu)),2); 
}

double increase_embedding_cpu_action_migrate_upf0_ns6(double embedding_cpu, double scaling_factor, double vnfs_required_cpu ) {
	 return round_k_digits(embedding_cpu+((scaling_factor) * (vnfs_required_cpu)),2); 
}

double decrease_embedding_bandwidth_action_migrate_upf0_ns6(double embedding_bandwidth, double required_bandwidth_embb ) {
	 return round_k_digits(embedding_bandwidth-(required_bandwidth_embb),2); 
}

double increase_embedding_bandwidth_action_migrate_upf0_ns6(double embedding_bandwidth, double required_bandwidth_embb ) {
	 return round_k_digits(embedding_bandwidth+(required_bandwidth_embb),2); 
}
...
double decrease_embedding_cpu_action_migrate_amf1_ns6(double embedding_cpu, double scaling_factor, double vnfs_required_cpu ) {
	 return round_k_digits(embedding_cpu-((scaling_factor) * (vnfs_required_cpu)),2); 
}

double increase_embedding_cpu_action_migrate_amf1_ns6(double embedding_cpu, double scaling_factor, double vnfs_required_cpu ) {
	 return round_k_digits(embedding_cpu+((scaling_factor) * (vnfs_required_cpu)),2); 
}

double decrease_embedding_bandwidth_action_migrate_amf1_ns6(double embedding_bandwidth, double required_bandwidth_embb ) {
	 return round_k_digits(embedding_bandwidth-(required_bandwidth_embb),2); 
}

double increase_embedding_bandwidth_action_migrate_amf1_ns6(double embedding_bandwidth, double required_bandwidth_embb ) {
	 return round_k_digits(embedding_bandwidth+(required_bandwidth_embb),2); 
}
...
double decrease_embedding_cpu_action_migrate_smf1_ns6(double embedding_cpu, double scaling_factor, double vnfs_required_cpu ) {
	 return round_k_digits(embedding_cpu-((scaling_factor) * (vnfs_required_cpu)),2); 
}

double increase_embedding_cpu_action_migrate_smf1_ns6(double embedding_cpu, double scaling_factor, double vnfs_required_cpu ) {
	 return round_k_digits(embedding_cpu+((scaling_factor) * (vnfs_required_cpu)),2); 
}

double decrease_embedding_bandwidth_action_migrate_smf1_ns6(double embedding_bandwidth, double required_bandwidth_embb ) {
	 return round_k_digits(embedding_bandwidth-(required_bandwidth_embb),2); 
}

double increase_embedding_bandwidth_action_migrate_smf1_ns6(double embedding_bandwidth, double required_bandwidth_embb ) {
	 return round_k_digits(embedding_bandwidth+(required_bandwidth_embb),2); 
}
