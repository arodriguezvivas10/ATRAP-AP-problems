(define (problem instance-4n-6s-5v)

	(:domain domain-4n-6s-5v)
	...
	(:init
        ...
        (=(substrate-bandwidth-capacity) 400) ; 2*200Gbps
		...
		(= (embedding-bandwidth n2-n4) 280) 
		(= (embedding-bandwidth n3-n4) 360) 
		(= (embedding-bandwidth n1-n4) 360) 
