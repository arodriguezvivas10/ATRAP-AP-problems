domain: file "../pddl-codes/4n-4s-5v/domain-4n-4s-5v.pddl"
problem: file "../pddl-codes/4n-4s-5v/instance-4n-4s-5v.pddl"
...
externfun decrease_embedding_cpu_action_migrate_amf0_ns1(embedding_cpu : real_type ; scaling_factor : real_type ; vnfs_required_cpu : real_type ; ): real_type "../pddl-codes/4n-4s-5v/domain-4n-4s-5v.h" ;
...
externfun decrease_embedding_bandwidth_action_migrate_amf1_ns2(embedding_bandwidth : real_type ; required_bandwidth_urllc : real_type ; ): real_type ;
externfun increase_embedding_bandwidth_action_migrate_amf1_ns2(embedding_bandwidth : real_type ; required_bandwidth_urllc : real_type ; ): real_type ;
...
externfun decrease_embedding_bandwidth_action_migrate_smf1_ns2(embedding_bandwidth : real_type ; required_bandwidth_urllc : real_type ; ): real_type ;
externfun increase_embedding_bandwidth_action_migrate_smf1_ns2(embedding_bandwidth : real_type ; required_bandwidth_urllc : real_type ; ): real_type ;
...
externfun decrease_embedding_bandwidth_action_migrate_amf1_ns3(embedding_bandwidth : real_type ; required_bandwidth_urllc : real_type ; ): real_type ;
externfun increase_embedding_bandwidth_action_migrate_amf1_ns3(embedding_bandwidth : real_type ; required_bandwidth_urllc : real_type ; ): real_type ;
...
externfun decrease_embedding_bandwidth_action_migrate_smf1_ns3(embedding_bandwidth : real_type ; required_bandwidth_urllc : real_type ; ): real_type ;
externfun increase_embedding_bandwidth_action_migrate_smf1_ns3(embedding_bandwidth : real_type ; required_bandwidth_urllc : real_type ; ): real_type ;
...
embedding_bandwidth[to_path2] := decrease_embedding_bandwidth_action_migrate_upf0_ns2(embedding_bandwidth[to_path2] , required_bandwidth_urllc  );
embedding_bandwidth[from_path2] := increase_embedding_bandwidth_action_migrate_upf0_ns2(embedding_bandwidth[from_path2] , required_bandwidth_urllc  );
...
embedding_bandwidth[to_path1] := decrease_embedding_bandwidth_action_migrate_amf1_ns2(embedding_bandwidth[to_path1] , required_bandwidth_urllc  );
embedding_bandwidth[from_path1] := increase_embedding_bandwidth_action_migrate_amf1_ns2(embedding_bandwidth[from_path1] , required_bandwidth_urllc  );
embedding_bandwidth[to_path2] := decrease_embedding_bandwidth_action_migrate_amf1_ns2(embedding_bandwidth[to_path2] , required_bandwidth_urllc  );
embedding_bandwidth[from_path2] := increase_embedding_bandwidth_action_migrate_amf1_ns2(embedding_bandwidth[from_path2] , required_bandwidth_urllc  );
...
(vnf_mapped_to[vnf_to_migrate][from_node]) & (!(=[from_node][to_node])) & ((( (embedding_cpu[to_node]) / ((scaling_factor) * (vnfs_required_cpu))) >= (1.00000))) & (link_mapped_to[link_to_migrate][from_path]) & (!(=[from_path][to_path])) & (next_vnf[prev_vnf][vnf_to_migrate]) & (vnf_mapped_to[prev_vnf][amf1_ns2_node]) & (adjacent_nodes_i_j[to_path][amf1_ns2_node][to_node]) & (adjacent_nodes_j_i[to_path][to_node][amf1_ns2_node]) & ((( (embedding_bandwidth[to_path]) / (required_bandwidth_urllc)) >= (1.00000))) ==> 
...
embedding_bandwidth[to_path] := decrease_embedding_bandwidth_action_migrate_smf1_ns2(embedding_bandwidth[to_path] , required_bandwidth_urllc  );
embedding_bandwidth[from_path] := increase_embedding_bandwidth_action_migrate_smf1_ns2(embedding_bandwidth[from_path] , required_bandwidth_urllc  );
...
embedding_bandwidth[to_path2] := decrease_embedding_bandwidth_action_migrate_upf0_ns3(embedding_bandwidth[to_path2] , required_bandwidth_urllc  );
embedding_bandwidth[from_path2] := increase_embedding_bandwidth_action_migrate_upf0_ns3(embedding_bandwidth[from_path2] , required_bandwidth_urllc  );
...
embedding_bandwidth[to_path1] := decrease_embedding_bandwidth_action_migrate_amf1_ns3(embedding_bandwidth[to_path1] , required_bandwidth_urllc  );
embedding_bandwidth[from_path1] := increase_embedding_bandwidth_action_migrate_amf1_ns3(embedding_bandwidth[from_path1] , required_bandwidth_urllc  );
embedding_bandwidth[to_path2] := decrease_embedding_bandwidth_action_migrate_amf1_ns3(embedding_bandwidth[to_path2] , required_bandwidth_urllc  );
embedding_bandwidth[from_path2] := increase_embedding_bandwidth_action_migrate_amf1_ns3(embedding_bandwidth[from_path2] , required_bandwidth_urllc  );
...
(vnf_mapped_to[vnf_to_migrate][from_node]) & (!(=[from_node][to_node])) & ((( (embedding_cpu[to_node]) / ((scaling_factor) * (vnfs_required_cpu))) >= (1.00000))) & (link_mapped_to[link_to_migrate][from_path]) & (!(=[from_path][to_path])) & (next_vnf[prev_vnf][vnf_to_migrate]) & (vnf_mapped_to[prev_vnf][amf1_ns3_node]) & (adjacent_nodes_i_j[to_path][amf1_ns3_node][to_node]) & (adjacent_nodes_j_i[to_path][to_node][amf1_ns3_node]) & ((( (embedding_bandwidth[to_path]) / (required_bandwidth_urllc)) >= (1.00000))) ==> 
...
embedding_bandwidth[to_path] := decrease_embedding_bandwidth_action_migrate_smf1_ns3(embedding_bandwidth[to_path] , required_bandwidth_urllc  );
embedding_bandwidth[from_path] := increase_embedding_bandwidth_action_migrate_smf1_ns3(embedding_bandwidth[from_path] , required_bandwidth_urllc  );
...
vnf_mapped_to[amf0_3][n2]:= true; 
vnf_mapped_to[smf0_3][n3]:= true; 
vnf_mapped_to[upf0_3][n2]:= true; 
vnf_mapped_to[amf1_3][n4]:= true; 
vnf_mapped_to[smf1_3][n3]:= true; 
link_mapped_to[amf0_smf0_3][n2_n3]:= true; 
link_mapped_to[smf0_upf0_3][n2_n4]:= true; 
link_mapped_to[upf0_amf1_3][n2_n4]:= true; 
link_mapped_to[amf1_smf1_3][n3_n4]:= true; 
...
vnf_mapped_to[smf0_4][n2]:= true; 
vnf_mapped_to[upf0_4][n1]:= true; 
vnf_mapped_to[amf1_4][n4]:= true; 
vnf_mapped_to[smf1_4][n4]:= true; 
link_mapped_to[amf0_smf0_4][inner_path_n2]:= true; 
link_mapped_to[smf0_upf0_4][n1_n2]:= true; 
link_mapped_to[upf0_amf1_4][n1_n4]:= true; 
link_mapped_to[amf1_smf1_4][inner_path_n4]:= true; 
embedding_cpu[n1] := 88.0000;
embedding_cpu[n2] := 16.0000;
embedding_cpu[n3] := 76.0000;
embedding_cpu[n4] := 28.0000;
embedding_bandwidth[n1_n2] := 160.000;
embedding_bandwidth[n1_n3] := 200.000;
embedding_bandwidth[n2_n4] := 100.000;
embedding_bandwidth[n3_n4] := 160.000;
embedding_bandwidth[n1_n4] := 160.000;
embedding_bandwidth[n2_n3] := 180.000;
