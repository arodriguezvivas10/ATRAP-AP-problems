domain: file "../pddl-codes/4n-2s-5v/domain-4n-2s-5v.pddl"
problem: file "../pddl-codes/4n-2s-5v/instance-4n-2s-5v.pddl"
...
externfun decrease_embedding_cpu_action_migrate_amf0_ns1(embedding_cpu : real_type ; scaling_factor : real_type ; vnfs_required_cpu : real_type ; ): real_type "../pddl-codes/4n-2s-5v/domain-4n-2s-5v.h" ;
...
embedding_cpu[n3] := 88.0000;
embedding_cpu[n4] := 16.0000;
embedding_bandwidth[n1_n2] := 180.000;
embedding_bandwidth[n1_n3] := 200.000;
embedding_bandwidth[n2_n4] := 140.000;
...
goal "enjoy" 
 ((( embedding_cpu[n1]) < ((0.600000) * (substrate_cpu_capacity)))) & ((( embedding_cpu[n2]) < ((0.600000) * (substrate_cpu_capacity)))) & ((( embedding_cpu[n3]) < ((0.600000) * (substrate_cpu_capacity)))) & ((( embedding_cpu[n4]) < ((0.600000) * (substrate_cpu_capacity))))& !DAs_ongoing_in_goal_state(); 
