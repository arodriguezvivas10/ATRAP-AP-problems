domain: file "../pddl-codes/4n-6s-3v/domain-4n-6s-3v.pddl"
problem: file "../pddl-codes/4n-6s-3v/instance-4n-6s-3v.pddl"
...
externfun decrease_embedding_cpu_action_migrate_amf0_ns1(embedding_cpu : real_type ; scaling_factor : real_type ; vnfs_required_cpu : real_type ; ): real_type "../pddl-codes/4n-6s-3v/domain-4n-6s-3v.h" ;
...
next_vnf[amf0_6][smf0_6]:= true; 
next_vnf[smf0_6][upf0_6]:= true; 
vnf_mapped_to[amf0_6][n4]:= true; 
vnf_mapped_to[smf0_6][n3]:= true; 
vnf_mapped_to[upf0_6][n3]:= true; 
link_mapped_to[amf0_smf0_6][n3_n4]:= true; 
link_mapped_to[smf0_upf0_6][inner_path_n3]:= true; 
embedding_cpu[n1] := 152.000;
embedding_cpu[n2] := 80.0000;
embedding_cpu[n3] := 128.000;
embedding_cpu[n4] := 104.000;
embedding_bandwidth[n1_n2] := 400.000;
embedding_bandwidth[n1_n3] := 800.000;
embedding_bandwidth[n2_n4] := 760.000;
embedding_bandwidth[n3_n4] := 300.000;
embedding_bandwidth[n1_n4] := 780.000;
