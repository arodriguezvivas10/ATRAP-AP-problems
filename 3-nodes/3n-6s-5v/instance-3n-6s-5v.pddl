(define (problem instance-3n-6s-5v)

	(:domain domain-3n-6s-5v)
	...
	(:init
        ...
        (=(substrate-bandwidth-capacity) 200) ; 200Mbps
		...
		(vnf-mapped-to amf1-1 n1)
		(vnf-mapped-to smf1-1 n3)
		;links mappings
		(link-mapped-to amf0-smf0-1 n1-n2)
		(link-mapped-to smf0-upf0-1 n1-n2)
		(link-mapped-to upf0-amf1-1 n1-n2)
		(link-mapped-to amf1-smf1-1 n1-n3)
		...
		(vnf-mapped-to amf1-2 n3)
		(vnf-mapped-to smf1-2 n3)
		;links mappings
		(link-mapped-to amf0-smf0-2 inner-path-n2)
		(link-mapped-to smf0-upf0-2 n1-n2)
		(link-mapped-to upf0-amf1-2 n1-n3)
		(link-mapped-to amf1-smf1-2 inner-path-n3)
		...
		(vnf-mapped-to smf0-4 n1)
		(vnf-mapped-to upf0-4 n2)
		(vnf-mapped-to amf1-4 n1)
		(vnf-mapped-to smf1-4 n3)
		;links mappings
		(link-mapped-to amf0-smf0-4 n1-n2)
		(link-mapped-to smf0-upf0-4 n1-n2)
		(link-mapped-to upf0-amf1-4 n1-n2)
		(link-mapped-to amf1-smf1-4 n1-n3)
		...
		(vnf-mapped-to amf1-5 n3)
		(vnf-mapped-to smf1-5 n3)
		;links mappings
		(link-mapped-to amf0-smf0-5 inner-path-n2)
		(link-mapped-to smf0-upf0-5 n1-n2)
		(link-mapped-to upf0-amf1-5 n1-n3)
		(link-mapped-to amf1-smf1-5 inner-path-n3)
		...
		(= (embedding-bandwidth n1-n2) 40)
		(= (embedding-bandwidth n1-n3) 120)
	...
	(:goal (and
			...
			(>(embedding-bandwidth n1-n2)40)
			(<(embedding-bandwidth n2-n3)(substrate-bandwidth-capacity))
		)
	)
	)
