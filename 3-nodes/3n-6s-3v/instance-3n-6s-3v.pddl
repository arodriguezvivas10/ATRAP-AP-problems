(define (problem instance-3n-6s-3v)

	(:domain domain-3n-6s-3v)
	...
	(:init
        ...
        (=(substrate-bandwidth-capacity) 200) ; 2*200Mbps
		...
		;links mappings
		(link-mapped-to amf0-smf0-3 n1-n3)
		...
		; vnfs mappings
		(vnf-mapped-to amf0-6 n1)
		(vnf-mapped-to smf0-6 n3)
		(vnf-mapped-to upf0-6 n3)
		;links mappings
		(link-mapped-to amf0-smf0-6 n1-n3)
		...
		(= (embedding-bandwidth n1-n2) 140)
		(= (embedding-bandwidth n1-n3) 160)
