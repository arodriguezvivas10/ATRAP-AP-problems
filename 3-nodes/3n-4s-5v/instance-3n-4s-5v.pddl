(define (problem instance-3n-4s-5v)

	(:domain domain-3n-4s-5v)
	...
	(:init
		...
		(link-mapped-to smf0-upf0-3 n2-n3)
		(link-mapped-to upf0-amf1-3 n1-n2)
		(link-mapped-to amf1-smf1-3 n1-n3)
		...
		(vnf-mapped-to smf0-4 n2)
		(vnf-mapped-to upf0-4 n1)
		(vnf-mapped-to amf1-4 n3)
		(vnf-mapped-to smf1-4 n3)
		;links mappings
		(link-mapped-to amf0-smf0-4 inner-path-n2)
		(link-mapped-to smf0-upf0-4 n1-n2)
		(link-mapped-to upf0-amf1-4 n1-n3)
		(link-mapped-to amf1-smf1-4 inner-path-n3)
		...
		(= (embedding-bandwidth n1-n2) 80)
		(= (embedding-bandwidth n1-n3) 120)
		(= (embedding-bandwidth n2-n3) 160)
